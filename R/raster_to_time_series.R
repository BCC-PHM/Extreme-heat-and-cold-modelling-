...
##################################################################################
#this will take so long to run try the doParallel script at the bottom 
#rename the colnames
...
# write_fst(final_output, "data/processed/tmean_lsoa_daily.fst", compress = 100)

saveRDS(final_output, "data/processed/tmean_lsoa_daily.rds")
